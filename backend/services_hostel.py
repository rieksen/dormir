...
ROOM_SEED_DATA = [
    ("R01", 650000, 2), ("R02", 900000, 1), ("R03", 800000, 2), ("R04", 800000, 2),
    ("R05", 800000, 2), ("R06", 800000, 2), ("R7A", 650000, 1), ("R7B", 850000, 1),
    ("R08", 800000, 2), ("R09", 750000, 2), ("R10", 900000, 1), ("R11", 900000, 1),
    ("R12", 900000, 1), ("R13", 1000000, 1), ("R14", 800000, 1), ("R15", 800000, 2),
    ("R16", 900000, 1), ("R17", 850000, 1), ("R18", 850000, 1), ("R19A", 1100000, 1),
    ("R19B", 850000, 1), ("R20", 800000, 2), ("R21", 800000, 2), ("R22", 850000, 1),
    ("R23", 850000, 1), ("R24", 850000, 1), ("R25", 850000, 1), ("R26", 900000, 1),
    ("R27", 900000, 1), ("R28", 900000, 1), ("R29", 900000, 1), ("R30", 800000, 2),
    ("R31", 800000, 2), ("R32", 800000, 2), ("R33", 800000, 2), ("R34", 800000, 2),
    ("R35", 700000, 2), ("R36", 750000, 2), ("R37", 850000, 2), ("R38", 800000, 2),
    ("R39", 800000, 2), ("R40", 800000, 1), ("R41", 1100000, 1), ("R42", 1100000, 1),
    ("R43", 800000, 2), ("R44", 800000, 2), ("R45", 800000, 1), ("R46", 1100000, 1),
    ("R47", 1100000, 1), ("R48", 800000, 1), ("R49", 900000, 1), ("R50", 900000, 1),
    ("R51", 900000, 1), ("R52", 1100000, 1), ("R53", 800000, 2), ("R54", 900000, 1),
